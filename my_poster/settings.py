"""
Django settings for my_poster project.
...
SECRET_KEY = '5irj=odv21x1*p+9$b6zbs*5sq=p@$sbhv@06t=bj6ogs)g)h3'
...
WSGI_APPLICATION = 'my_poster.wsgi.application'
